...
export default function AddSongForm({
  ...
  return (
    <>
      <div className="flex items-center justify-between bg-linear-to-t from-sky-500 to-indigo-500">
        <h1 className="text-xl font-bold text-gray-400 bg-linear-to-t from-sky-500 to-indigo-500">Add a song</h1>
      </div>
